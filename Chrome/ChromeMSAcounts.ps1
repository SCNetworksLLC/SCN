<#   
.DESCRIPTION
    Adds the Microsoft Accounts Google Chrome extension to the forced install list.
...
# Microsoft Accounts Extension. This can be any extension. Modify to suit any needs
